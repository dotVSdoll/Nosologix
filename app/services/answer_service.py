        ...
        if use_llm:
            try:
                ...
                return GroundedAnswerResponse(
                    ...
                    limitations=[citations_note, exc.safe_message()],
                    risk_level=safety.risk_level,
                    should_seek_doctor=safety.should_seek_doctor,
                    safety_warnings=safety.safety_warnings,
                    evidence_status=evidence_status,
                    evidence_warnings=evidence_warnings,
                    llm_error_type=exc.error_type,
                    llm_error_status_code=exc.status_code,
                    llm_error_code=exc.error_code,
                    llm_error_retryable=exc.retryable,
